...
public class ExercResolvido23 {
    ...
    public static void main(String[] args) {
        ...
        if (salMin > 0 && qtdHoraTrabalhada > 0) {
            // Desvio condicional referente ao turno
            ...
            // Operação referente ao salário bruto
            salBruto = qtdHoraTrabalhada * coeficiente;

            // Desvio condicional referente a categoria
            ...
            // Desvio condicional referente ao auxílio alimentação
            ...
            // operação referente ao salário líquido
            salLiquido = salBruto - imposto + gratificacao + auxAlimentacao;

            // Desvio condicional referente a mensagem
            if (salLiquido < 350) {
